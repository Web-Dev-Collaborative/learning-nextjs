...
"use strict";function _objectWithoutProperties(t,e){if(null==t)return{};var o,c,n=_objectWithoutPropertiesLoose(t,e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);for(c=0;c<r.length;c++)o=r[c],e.indexOf(o)>=0||Object.prototype.propertyIsEnumerable.call(t,o)&&(n[o]=t[o])}return n}function _objectWithoutPropertiesLoose(t,e){if(null==t)return{};var o,c,n={},r=Object.keys(t);for(c=0;c<r.length;c++)o=r[c],e.indexOf(o)>=0||(n[o]=t[o]);return n}var enc=encodeURIComponent;module.exports=function(t){var e=t.query,o=t.params,c=void 0===o?{}:o,n=t.options,r=void 0===n?{}:n,u=r.tag,i=_objectWithoutProperties(r,["tag"]),a="query=".concat(enc(e)),s=u?"?tag=".concat(enc(u),"&").concat(a):"?".concat(a),p=Object.keys(c).reduce(function(t,e){return"".concat(t,"&").concat(enc("$".concat(e)),"=").concat(enc(JSON.stringify(c[e])))},s);return Object.keys(i).reduce(function(t,e){return r[e]?"".concat(t,"&").concat(enc(e),"=").concat(enc(r[e])):t},p)};
