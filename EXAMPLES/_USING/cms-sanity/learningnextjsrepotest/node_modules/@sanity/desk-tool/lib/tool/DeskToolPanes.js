...
var _resizeObserver = require("@sanity/base/lib/util/resizeObserver");
  ...
  componentDidMount() {
    ...
    if (autoCollapse) {
      ...
      if (this._rootElement && this._rootElement.current) {
        this.unobserveRootElementResize = _resizeObserver.resizeObserver.observe(this._rootElement.current, this.handleResize);
      }
