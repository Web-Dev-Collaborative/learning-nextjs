...
var _ChangeFieldWrapper = require("@sanity/base/lib/change-indicators/ChangeFieldWrapper");
...
function ChangesPanel(_ref) {
  ...
  var documentContext = _react.default.useMemo(() => ({
    documentId,
    schemaType,
    FieldWrapper: _ChangeFieldWrapper.ChangeFieldWrapper,
    rootDiff: diff,
    isComparingCurrent
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    since: since
  }) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "Since unknown version")))), changeAnnotations.length > 0 && /*#__PURE__*/_react.default.createElement(_diff.DiffTooltip, {
    annotations: changeAnnotations,
    description: "Changes by",
    placement: "bottom"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: _changesPanel.default.changeAuthorsContainer
  }, /*#__PURE__*/_react.default.createElement(_avatar.AvatarStack, {
    className: _changesPanel.default.changeAuthorsAvatarStack,
    maxLength: 4
  }, changeAnnotations.map(_ref2 => {
    var author = _ref2.author;
    return /*#__PURE__*/_react.default.createElement(_components.UserAvatar, {
      key: author,
      userId: author // position="bottom"

    });
  })))))), /*#__PURE__*/_react.default.createElement(_tooltip.TooltipProvider, {
    boundaryElement: scrollRef.current
