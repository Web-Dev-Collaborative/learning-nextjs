...
var _ArrayOfOptionsFieldDiff = _interopRequireDefault(require("./ArrayOfOptionsFieldDiff.css"));
...
var ArrayOfOptionsFieldDiff = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, diff.items.map(item => normalizeItems(item, diff, schemaType)).filter(item => item !== null).sort(sortItems).map((item, index) => {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayOfOptionsFieldDiff.default.item,
      key: getItemKey(diff, index)
    }, /*#__PURE__*/_react.default.createElement(_diff.DiffTooltip, {
      annotations: annotation ? [annotation] : [],
      description: action
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayOfOptionsFieldDiff.default.checkboxes
      ...
      className: _ArrayOfOptionsFieldDiff.default.label
...
function ItemPreview(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: _ArrayOfOptionsFieldDiff.default.itemPreview
