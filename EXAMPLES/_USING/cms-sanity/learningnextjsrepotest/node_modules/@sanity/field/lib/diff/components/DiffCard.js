...
var _DiffCard = _interopRequireDefault(require("./DiffCard.css"));
...
var DiffCardWithAnnotation = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  var elementProps = _objectSpread(_objectSpread({}, restProps), {}, {
    className: (0, _classnames.default)(_DiffCard.default.root, className),
  ...
  var element = /*#__PURE__*/(0, _react.createElement)(as, elementProps, children);
