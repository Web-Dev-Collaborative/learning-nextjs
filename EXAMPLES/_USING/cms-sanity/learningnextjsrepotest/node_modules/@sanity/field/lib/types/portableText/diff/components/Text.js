...
var _Text = _interopRequireDefault(require("./Text.css"));
...
function TextWithDiff(_ref2) {
  ...
  var className = (0, _classnames.default)(_Text.default.root, _Text.default.changed);
  ...
  return /*#__PURE__*/_react.default.createElement("span", _extends({}, restProps, {
    ...
    className: _Text.default.previewContainer
  }, /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, diffCard || children)));
}