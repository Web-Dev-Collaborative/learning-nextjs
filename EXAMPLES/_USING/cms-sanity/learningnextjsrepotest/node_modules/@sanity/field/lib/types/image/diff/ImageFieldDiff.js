...
var _ImageFieldDiff = _interopRequireDefault(require("./ImageFieldDiff.css"));
...
var ImageFieldDiff = _ref => {
  ...
  var from = fromValue && fromRef ? /*#__PURE__*/React.createElement(_diff.DiffCard, {
    className: _ImageFieldDiff.default.annotation,
  ...
  if (!from && !to) {
    return /*#__PURE__*/React.createElement("div", {
      className: _ImageFieldDiff.default.root
    }, /*#__PURE__*/React.createElement("div", {
      className: _ImageFieldDiff.default.emptyMessage
    }, /*#__PURE__*/React.createElement("span", null, "Image not set")));
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: _ImageFieldDiff.default.root
  }, showImageDiff && (didAssetChange ? /*#__PURE__*/React.createElement(_diff.DiffTooltip, {
    annotations: assetAnnotation ? [assetAnnotation] : [],
    description: "".concat(assetAction[0].toUpperCase()).concat(assetAction.slice(1))
  }, imageDiff) : imageDiff), nestedFields.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: _ImageFieldDiff.default.nestedFields
