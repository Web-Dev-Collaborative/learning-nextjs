...
export declare const FormFieldSet: React.ForwardRefExoticComponent<FormFieldSetProps & Omit<React.HTMLProps<HTMLDivElement>, "ref" | "as" | "height"> & React.RefAttributes<unknown>>;
