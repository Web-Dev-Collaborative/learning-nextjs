...
function CorsWrapper(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("p", null, "Error message:"), /*#__PURE__*/_react.default.createElement("pre", null, /*#__PURE__*/_react.default.createElement("code", null, response.body.message)), children);
}
...
function CorsCheck() {
  ...
  if (result.isCorsError) {
    return /*#__PURE__*/_react.default.createElement(CorsWrapper, {
      result: state.result
    }, /*#__PURE__*/_react.default.createElement("p", null, "It looks like the error is being caused by the current origin (", /*#__PURE__*/_react.default.createElement("code", null, origin), ") not being allowed for this project. If you are a project administrator or developer, you can head to", ' ', /*#__PURE__*/_react.default.createElement("a", {
  ...
  return /*#__PURE__*/_react.default.createElement(CorsWrapper, {
    result: state.result
  }, /*#__PURE__*/_react.default.createElement("p", null, "It might be that your internet connection is unstable or down. You could try hitting the", ' ', /*#__PURE__*/_react.default.createElement("strong", null, "Retry"), " button to see if it was just a temporary glitch."));
}