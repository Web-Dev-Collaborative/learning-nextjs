...
class LoginWrapper extends _react.default.PureComponent {
  constructor(props) {
    ...
    var sync = true;
    this.userSubscription = _user.default.me.pipe((0, _operators.map)(currentUser => ({
      user: currentUser,
      isLoading: false
